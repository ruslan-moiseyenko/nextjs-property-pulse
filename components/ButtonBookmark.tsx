...
export const ButtonBookmark: FC<ButtonBookmarkProps> = ({ property }) => {
  ...
  return (
    <button
      onClick={handleClick}
      className={`flex w-full items-center justify-center rounded-full  ${isBookmarked ? "bg-red-500 hover:bg-red-600" : "bg-blue-500 hover:bg-blue-600"} px-4 py-2 font-bold text-white `}
    >
